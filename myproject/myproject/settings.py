...
from pathlib import Path # Importa Path para manipulación de rutas y archivos de forma sencilla  
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Añade la ruta a la carpeta de templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
