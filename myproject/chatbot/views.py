...
from django.shortcuts import render # Renderiza plantillas HTML
from urllib.parse import urlparse # Analiza y descompone URLs
from .functions import * # Importa todas las funciones personalizadas del proyecto
from .opciones_proyectos import * # Importa las opciones de configuración de proyectos
from .posibles_preguntas import obtener_pregunta # Importa la función para obtener preguntas
from .rutas import * # Importa las rutas personalizadas del proyecto
from .validators import * # Importa los validadores
